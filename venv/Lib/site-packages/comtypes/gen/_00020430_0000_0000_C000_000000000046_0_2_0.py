...
IFontDisp = Font
__all__ = [ 'OLE_CANCELBOOL', 'FONTUNDERSCORE', 'FONTSIZE', 'Font',
           'OLE_YPOS_HIMETRIC', 'Picture', 'IFontDisp',
           'OLE_XSIZE_CONTAINER', 'Monochrome', 'Default',
           'FONTSTRIKETHROUGH', 'Checked', 'OLE_ENABLEDEFAULTBOOL',
           'IFont', 'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_HIMETRIC',
           'FONTITALIC', 'FONTNAME', 'OLE_XPOS_HIMETRIC',
           'OLE_YPOS_PIXELS', 'OLE_HANDLE', 'StdPicture', 'IPicture',
           'FONTBOLD', 'OLE_COLOR', 'Unchecked', 'FontEvents',
           'LoadPictureConstants', 'OLE_XPOS_PIXELS',
           'IFontEventsDisp', 'OLE_YSIZE_HIMETRIC',
           'OLE_XSIZE_PIXELS', 'VgaColor', 'OLE_XPOS_CONTAINER',
           'OLE_TRISTATE', 'OLE_YPOS_CONTAINER', 'IPictureDisp',
           'Gray', 'OLE_YSIZE_PIXELS', 'Color', 'OLE_OPTEXCLUSIVE',
           'StdFont']
